...
from fcr_app.chart import plot_preview, plot_weight_curve
...
class Worker(QThread):
    ...
    def __init__(self, filepath, output_dir, min_age, max_age, init_lower, init_upper):
        super().__init__()
...
class MainWindow(QMainWindow):
    ...
    def _start_calc(self):
        ...
        if not output_dir:
            output_dir = os.path.join(os.path.dirname(filepath), "fcr_results")
        ...
        self._worker = Worker(filepath, output_dir,
